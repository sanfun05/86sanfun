...
export const Footer: React.FC<FooterProps> = ({ totalArticles, totalMoments, onOpenAIChat, onOpenAdmin, siteConfig, profile, layoutConfig, onTabChange }) => {
  ...
  return (
    <footer className="mt-5 border-t border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md pt-3.5 pb-3.5 transition-colors duration-300">
      <div className={`${adaptiveWidthClass} w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-2.5 transition-all duration-300`}>
        
        {/* Top Footer Banner / Links Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 pb-2.5 border-b border-zinc-200/60 dark:border-zinc-800/60">
          
          {/* Brand Info */}
          <div className="md:col-span-5 space-y-1">
            <div className="flex items-center space-x-2">
              <div className="w-6.5 h-6.5 rounded-lg flex items-center justify-center font-black text-white text-xs shadow-xs shadow-indigo-500/25 bg-gradient-to-tr from-indigo-600 via-blue-600 to-indigo-500 border border-white/20 shrink-0">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 max-w-md leading-tight">
              {siteConfig?.siteSubtitle || '设计即态度。专注于构建无障碍 UI 系统、全栈 Web 应用与 AI 智能体验，探索技术与美学的结合。'}
            </p>
            <div className="flex items-center gap-1.5 text-[11px] text-zinc-400 font-mono pt-0.5 leading-none">
          ...
          <div className="md:col-span-4 space-y-1">
            ...
            <div className="grid grid-cols-2 gap-x-2 gap-y-0.5 text-xs leading-tight">
              <button onClick={() => onTabChange?.('home')} className="text-left text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-0.5">
                • 博客首页
              </button>
              <button onClick={() => onTabChange?.('articles')} className="text-left text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-0.5">
                • 文章文库 ({totalArticles})
              </button>
              <button onClick={() => onTabChange?.('columns')} className="text-left text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-0.5">
                • 专栏分类
              </button>
              <button onClick={() => onTabChange?.('friends')} className="text-left text-zinc-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-0.5">
                • 友链朋友圈
              </button>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-1">
            ...
            <div className="bg-zinc-100/80 dark:bg-zinc-900/80 p-2 rounded-xl border border-zinc-200/60 dark:border-zinc-800/60 space-y-1">
              ...
              <div className="text-[11px] font-mono text-zinc-400 border-t border-zinc-200/50 dark:border-zinc-800/50 pt-0.5 flex justify-between leading-tight">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-1.5 text-xs leading-tight text-zinc-500 dark:text-zinc-400">
